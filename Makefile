...
CFLAGS=-Wall --std=c99 
# RUN FLAGS
OBJECTS=./build/word.o ./build/word_vector.o ./build/word_bank.o ./build/game_state.o ./build/user_interface.o
# DEBUG FLAGS
CFLAGS_DEBUG=$(CFLAGS) -g
DEBUG_OBJECTS=./build_debug/word.o ./build_debug/word_vector.o ./build_debug/word_bank.o ./build_debug/game_state.o ./build_debug/user_interface.o
# LINKED LIBS
...
main: ./src/main.c $(OBJECTS)
	$(CC) $(CFLAGS) ./src/main.c $(OBJECTS) $(LINKER_FLAGS) -o play_wordle
...
./build/user_interface.o: ./src/user_interface/user_interface.c
	$(CC) $(CFLAGS) -g -c -o $@ $<

# DEBUG
debug: ./src/main.c $(OBJECTS)
	$(CC) $(CFLAGS_DEBUG) ./src/main.c $(OBJECTS) $(LINKER_FLAGS) -o play_wordle__debug
...
./build_debug/user_interface.o: ./src/user_interface/user_interface.c
	$(CC) $(CFLAGS_DEBUG) -g -c -o $@ $<
